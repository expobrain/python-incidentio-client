...
def _get_kwargs(
    *,
    ...
    url = f"{client.base_url}/x-audit-logs/api_key.deleted.1"
...
def _parse_response(*, response: httpx.Response) -> Optional[AuditLogsAPIKeyDeletedV1ResponseBody]:
...
def _build_response(*, response: httpx.Response) -> Response[AuditLogsAPIKeyDeletedV1ResponseBody]:
    return Response(
