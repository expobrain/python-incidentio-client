...
def _get_kwargs(
    *,
    ...
    url = f"{client.base_url}/x-audit-logs/policy.updated.1"
...
def _parse_response(*, response: httpx.Response) -> Optional[AuditLogsPolicyUpdatedV1ResponseBody]:
...
def _build_response(*, response: httpx.Response) -> Response[AuditLogsPolicyUpdatedV1ResponseBody]:
    return Response(
