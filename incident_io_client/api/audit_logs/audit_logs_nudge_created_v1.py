...
def _get_kwargs(
    *,
    ...
    url = f"{client.base_url}/x-audit-logs/nudge.created.1"
...
def _parse_response(*, response: httpx.Response) -> Optional[AuditLogsNudgeCreatedV1ResponseBody]:
...
def _build_response(*, response: httpx.Response) -> Response[AuditLogsNudgeCreatedV1ResponseBody]:
    return Response(
