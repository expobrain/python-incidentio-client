...
def _get_kwargs(
    *,
    ...
    url = f"{client.base_url}/x-audit-logs/policy.created.1"
...
def _parse_response(*, response: httpx.Response) -> Optional[AuditLogsPolicyCreatedV1ResponseBody]:
...
def _build_response(*, response: httpx.Response) -> Response[AuditLogsPolicyCreatedV1ResponseBody]:
    return Response(
