    ...
    *,
    ...
    Args:
        json_body (IncidentsCreateRequestBody):  Example: {'custom_field_entries':
            ...
            'incident_role_id': '01FH5TZRWMNAFB0DZ23FD1TV96'}, {'assignee': {'email':
            'bob@example.com', 'id': '01G0J1EXE7AXZ2C93K61WBPYEH', 'slack_user_id': 'USER123'},
            'incident_role_id': '01FH5TZRWMNAFB0DZ23FD1TV96'}], 'incident_type_id': 'Optio voluptatum
            rerum magnam alias.', 'mode': 'real', 'name': 'Our database is sad', 'severity_id': 'Et
            amet non sed sit quia.', 'source_message_channel_id': 'C02AW36C1M5',
