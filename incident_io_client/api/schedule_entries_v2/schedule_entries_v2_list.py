...
from ...models.schedule_entries_v2_list_response_body import (
...
) -> Optional[ScheduleEntriesV2ListResponseBody]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ScheduleEntriesV2ListResponseBody.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[ScheduleEntriesV2ListResponseBody]:
    return Response(
