...
def _parse_response(*, response: httpx.Response) -> Optional[IncidentRolesV1ShowResponseBody]:
...
def _build_response(*, response: httpx.Response) -> Response[IncidentRolesV1ShowResponseBody]:
    return Response(
