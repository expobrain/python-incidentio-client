...
T = TypeVar("T", bound="WeekdayIntervalV2ResponseBody")


@_attrs_define
class WeekdayIntervalV2ResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        weekday_interval_v2_response_body = cls(
            end_time=end_time,
            start_time=start_time,
            weekday=weekday,
        )

        weekday_interval_v2_response_body.additional_properties = d
        return weekday_interval_v2_response_body
