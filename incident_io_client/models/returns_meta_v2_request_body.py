...
T = TypeVar("T", bound="ReturnsMetaV2RequestBody")


@_attrs_define
class ReturnsMetaV2RequestBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        returns_meta_v2_request_body = cls(
            array=array,
            type=type,
        )

        returns_meta_v2_request_body.additional_properties = d
        return returns_meta_v2_request_body
