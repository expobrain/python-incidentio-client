...
T = TypeVar("T", bound="CustomFieldsCreateResponseBody")


@attr.s(auto_attribs=True)
class CustomFieldsCreateResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_fields_create_response_body = cls(
            custom_field=custom_field,
        )

        custom_fields_create_response_body.additional_properties = d
        return custom_fields_create_response_body
