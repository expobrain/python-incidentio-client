...
T = TypeVar("T", bound="SeveritiesUpdateResponseBody")


@attr.s(auto_attribs=True)
class SeveritiesUpdateResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        severities_update_response_body = cls(
            severity=severity,
        )

        severities_update_response_body.additional_properties = d
        return severities_update_response_body
