...
T = TypeVar("T", bound="ScheduleEntryV2ResponseBody")


@_attrs_define
class ScheduleEntryV2ResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        schedule_entry_v2_response_body = cls(
            end_at=end_at,
            start_at=start_at,
            entry_id=entry_id,
        ...
        schedule_entry_v2_response_body.additional_properties = d
        return schedule_entry_v2_response_body
