...
T = TypeVar("T", bound="CatalogEntryReference")


@_attrs_define
class CatalogEntryReference:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        catalog_entry_reference.additional_properties = d
        return catalog_entry_reference
