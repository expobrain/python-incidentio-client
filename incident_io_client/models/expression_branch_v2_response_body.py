...
T = TypeVar("T", bound="ExpressionBranchV2ResponseBody")


@_attrs_define
class ExpressionBranchV2ResponseBody:
    """
    Example:
    ...
    Attributes:
        condition_groups (List['ConditionGroupV2ResponseBody']): When theses conditions are met, this branch will be
        ...
        result (EngineParamBindingV2ResponseBody):  Example: {'array_value': [{'catalog_entry': {'archived_at':
            '2021-08-17T14:28:57.801578Z', 'catalog_entry_id': '01FCNDV6P870EA6S7TK1DSYDG0', 'catalog_entry_name': 'Primary
            escalation', 'catalog_type_id': '01FCNDV6P870EA6S7TK1DSYDG0'}, 'helptext': 'Collection of standalone automations
            like auto-closing incidents.', 'image_url': 'https://avatars.slack-
            edge.com/2021-08-09/2372763167857_6f65d94928b0a0ac590b_192.jpg', 'is_image_slack_icon': False, 'label':
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        expression_branch_v2_response_body = cls(
            condition_groups=condition_groups,
            result=result,
        )

        expression_branch_v2_response_body.additional_properties = d
        return expression_branch_v2_response_body
