...
T = TypeVar("T", bound="ReturnsMetaV2ResponseBody")


@_attrs_define
class ReturnsMetaV2ResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        returns_meta_v2_response_body = cls(
            array=array,
            type=type,
        )

        returns_meta_v2_response_body.additional_properties = d
        return returns_meta_v2_response_body
