...
T = TypeVar("T", bound="IncidentsShowResponseBody")


@attr.s(auto_attribs=True)
class IncidentsShowResponseBody:
    """
    Example:
        {'incident': {'call_url': 'https://zoom.us/foo', 'created_at': '2021-08-17T13:28:57.801578Z', 'creator':
            ...
            'role_type': 'lead', 'shortform': 'lead', 'updated_at': '2021-08-17T13:28:57.801578Z'}}], 'name': 'Our database
            is sad', 'permalink': 'Consequuntur odio qui dolor.', 'postmortem_document_url':
    ...
    Attributes:
        incident (IncidentResponseBody):  Example: {'call_url': 'https://zoom.us/foo', 'created_at':
            ...
            '01FCNDV6P870EA6S7TK1DSYDG0', 'instructions': 'Take point on the incident; Make sure people are clear on
            responsibilities', 'name': 'Incident Lead', 'required': True, 'role_type': 'lead', 'shortform': 'lead',
            'updated_at': '2021-08-17T13:28:57.801578Z'}}], 'name': 'Our database is sad', 'permalink': 'Alias aut rerum
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        incidents_show_response_body = cls(
            incident=incident,
        )

        incidents_show_response_body.additional_properties = d
        return incidents_show_response_body
