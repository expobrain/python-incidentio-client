...
class ScheduleV2ResponseBody:
    ...
    Example:
        {'annotations': {'incident.io/terraform/version': 'version-of-terraform'}, 'config': {'rotations':
            ...
            'U02AYNF2XJM'}}], 'id': '01G0J1EXE7AXZ2C93K61WBPYEH', 'name': 'Primary On-Call Schedule', 'timezone':
            'Europe/London', 'updated_at': '2021-08-17T13:28:57.801578Z'}

    Attributes:
        annotations (ScheduleV2ResponseBodyAnnotations): Annotations that can track metadata about this schedule
