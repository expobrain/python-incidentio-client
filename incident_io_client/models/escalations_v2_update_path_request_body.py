...
if TYPE_CHECKING:
    ...
    from ..models.weekday_interval_config_v2_request_body import (
...
class EscalationsV2UpdatePathRequestBody:
    ...
    Attributes:
        ...
        path (List['EscalationPathNodePayloadV2RequestBody']): The nodes that form the levels and branches of this
            escalation path. Example: [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'if_else': {'conditions': [{'operation':
            ...
            'then_path': [{}]}, 'level': {'targets': [{'id': 'lawrencejones', 'type': 'user', 'urgency': 'high'}],
            'time_to_ack_interval_condition': 'active', 'time_to_ack_seconds': 1800,
            'time_to_ack_weekday_interval_config_id': '01FCNDV6P870EA6S7TK1DSYDG0'}, 'repeat': {'repeat_times': 3,
            'to_node': '01FCNDV6P870EA6S7TK1DSYDG0'}, 'type': 'if_else'}].
        working_hours (Union[Unset, List['WeekdayIntervalConfigV2RequestBody']]): The working hours for this escalation
            path. Example: [{'id': 'abc123', 'name': 'abc123', 'timezone': 'abc123', 'weekday_intervals': [{'end_time':
            '17:00', 'start_time': '09:00', 'weekday': 'abc123'}]}].
    """

    name: str
    path: List["EscalationPathNodePayloadV2RequestBody"]
    working_hours: Union[Unset, List["WeekdayIntervalConfigV2RequestBody"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for path_item_data in _path:
            path_item = EscalationPathNodePayloadV2RequestBody.from_dict(path_item_data)
        ...
        for working_hours_item_data in _working_hours or []:
            working_hours_item = WeekdayIntervalConfigV2RequestBody.from_dict(
