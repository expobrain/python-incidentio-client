...
T = TypeVar("T", bound="EscalationPathRoundRobinConfigV2ResponseBody")


@_attrs_define
class EscalationPathRoundRobinConfigV2ResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        escalation_path_round_robin_config_v2_response_body = cls(
            enabled=enabled,
            rotate_after_seconds=rotate_after_seconds,
        )

        escalation_path_round_robin_config_v2_response_body.additional_properties = d
        return escalation_path_round_robin_config_v2_response_body
