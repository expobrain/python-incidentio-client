...
T = TypeVar("T", bound="CatalogEntryEngineParamBindingValueV2ResponseBody")


@_attrs_define
class CatalogEntryEngineParamBindingValueV2ResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        catalog_entry_engine_param_binding_value_v2_response_body = cls(
            label=label,
            sort_key=sort_key,
        ...
        catalog_entry_engine_param_binding_value_v2_response_body.additional_properties = d
        return catalog_entry_engine_param_binding_value_v2_response_body
