...
from ..models.update_workflow_payload_request_body_runs_on_incident_modes_item import (
    UpdateWorkflowPayloadRequestBodyRunsOnIncidentModesItem,
)
from ..models.update_workflow_payload_request_body_runs_on_incidents import (
    UpdateWorkflowPayloadRequestBodyRunsOnIncidents,
)
from ..models.update_workflow_payload_request_body_state import (
    UpdateWorkflowPayloadRequestBodyState,
)
...
if TYPE_CHECKING:
    ...
    from ..models.update_workflow_payload_request_body_annotations import (
        UpdateWorkflowPayloadRequestBodyAnnotations,
    )
    from ..models.workflow_delay_request_body import WorkflowDelayRequestBody


T = TypeVar("T", bound="UpdateWorkflowPayloadRequestBody")


@_attrs_define
class UpdateWorkflowPayloadRequestBody:
    """
    Example:
    ...
    Attributes:
        ...
        runs_on_incident_modes (List[UpdateWorkflowPayloadRequestBodyRunsOnIncidentModesItem]): Which modes of incident
            this should run on (defaults to just standard incidents) Example: ['standard', 'retrospective'].
        runs_on_incidents (UpdateWorkflowPayloadRequestBodyRunsOnIncidents): Which incidents should the workflow be
        ...
        steps (List['StepConfigPayloadRequestBody']): List of step to execute as part of the workflow Example:
            ...
            'incident.severity'}}]}].
        annotations (Union[Unset, UpdateWorkflowPayloadRequestBodyAnnotations]): Annotations that track internal
        ...
        state (Union[Unset, UpdateWorkflowPayloadRequestBodyState]): The state of the workflow (e.g. is it draft, or
    ...
    name: str
    once_for: List[str]
    runs_on_incident_modes: List[UpdateWorkflowPayloadRequestBodyRunsOnIncidentModesItem]
    runs_on_incidents: UpdateWorkflowPayloadRequestBodyRunsOnIncidents
    steps: List["StepConfigPayloadRequestBody"]
    annotations: Union[Unset, "UpdateWorkflowPayloadRequestBodyAnnotations"] = UNSET
    delay: Union[Unset, "WorkflowDelayRequestBody"] = UNSET
    folder: Union[Unset, str] = UNSET
    managed_source_url: Union[Unset, str] = UNSET
    state: Union[Unset, UpdateWorkflowPayloadRequestBodyState] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for runs_on_incident_modes_item_data in _runs_on_incident_modes:
            runs_on_incident_modes_item = UpdateWorkflowPayloadRequestBodyRunsOnIncidentModesItem(
        ...
        annotations: Union[Unset, UpdateWorkflowPayloadRequestBodyAnnotations]
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = UpdateWorkflowPayloadRequestBodyAnnotations.from_dict(_annotations)
        ...
        state: Union[Unset, UpdateWorkflowPayloadRequestBodyState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = UpdateWorkflowPayloadRequestBodyState(_state)

        update_workflow_payload_request_body = cls(
            condition_groups=condition_groups,
            continue_on_step_error=continue_on_step_error,
            expressions=expressions,
            include_private_incidents=include_private_incidents,
        ...
        update_workflow_payload_request_body.additional_properties = d
        return update_workflow_payload_request_body
