...
T = TypeVar("T", bound="AlertRouteIncidentTemplateV2ResponseBodyCustomFields")


@_attrs_define
class AlertRouteIncidentTemplateV2ResponseBodyCustomFields:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        alert_route_incident_template_v2_response_body_custom_fields = cls()
        ...
        alert_route_incident_template_v2_response_body_custom_fields.additional_properties = (
            additional_properties
        )
        return alert_route_incident_template_v2_response_body_custom_fields
