...
T = TypeVar("T", bound="AuditLogsLearningTaskDeletedV1ResponseBody")


@_attrs_define
class AuditLogsLearningTaskDeletedV1ResponseBody:
    """
    Example:
        {'action': 'learning_task.deleted', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata':
    ...
    Attributes:
        action (str): The type of log entry that this is Example: learning_task.deleted.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        audit_logs_learning_task_deleted_v1_response_body = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_learning_task_deleted_v1_response_body.additional_properties = d
        return audit_logs_learning_task_deleted_v1_response_body
