...
T = TypeVar("T", bound="AlertRouteIncidentTemplatePayloadV2RequestBodyCustomFields")


@_attrs_define
class AlertRouteIncidentTemplatePayloadV2RequestBodyCustomFields:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        alert_route_incident_template_payload_v2_request_body_custom_fields = cls()
        ...
        alert_route_incident_template_payload_v2_request_body_custom_fields.additional_properties = (
            additional_properties
        )
        return alert_route_incident_template_payload_v2_request_body_custom_fields
