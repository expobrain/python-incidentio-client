...
if TYPE_CHECKING:
    from ..models.schedule_layer_v2_response_body import ScheduleLayerV2ResponseBody
    from ..models.schedule_rotation_handover_v2_response_body import (
        ScheduleRotationHandoverV2ResponseBody,
    )
    from ..models.schedule_rotation_working_interval_v2_response_body import (
        ScheduleRotationWorkingIntervalV2ResponseBody,
    )
    from ..models.user_v2_response_body import UserV2ResponseBody


T = TypeVar("T", bound="ScheduleRotationV2ResponseBody")


@_attrs_define
class ScheduleRotationV2ResponseBody:
    """
    Example:
    ...
    Attributes:
        ...
        handovers (List['ScheduleRotationHandoverV2ResponseBody']): Defines the handover intervals for this rota, in
            order they should apply Example: [{'interval': 1, 'interval_type': 'daily'}].
        id (str): Unique internal ID of the rotation Example: 01G0J1EXE7AXZ2C93K61WBPYEH.
        layers (List['ScheduleLayerV2ResponseBody']): Controls how many people are on-call concurrently Example: [{'id':
        ...
        effective_from (Union[Unset, datetime.datetime]): When this rotation config will be effective from Example:
            2021-08-17T13:28:57.801578Z.
        users (Union[Unset, List['UserV2ResponseBody']]):  Example: [{'email': 'lisa@incident.io', 'id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Lisa Karlin Curtis', 'role': 'viewer', 'slack_user_id': 'U02AYNF2XJM'}].
        working_interval (Union[Unset, List['ScheduleRotationWorkingIntervalV2ResponseBody']]):  Example: [{'end_time':
            '17:00', 'start_time': '09:00', 'weekday': 'tuesday'}].
    """

    handover_start_at: datetime.datetime
    handovers: List["ScheduleRotationHandoverV2ResponseBody"]
    id: str
    layers: List["ScheduleLayerV2ResponseBody"]
    name: str
    effective_from: Union[Unset, datetime.datetime] = UNSET
    users: Union[Unset, List["UserV2ResponseBody"]] = UNSET
    working_interval: Union[Unset, List["ScheduleRotationWorkingIntervalV2ResponseBody"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for handovers_item_data in _handovers:
            handovers_item = ScheduleRotationHandoverV2ResponseBody.from_dict(handovers_item_data)
        ...
        for layers_item_data in _layers:
            layers_item = ScheduleLayerV2ResponseBody.from_dict(layers_item_data)
        ...
        for working_interval_item_data in _working_interval or []:
            working_interval_item = ScheduleRotationWorkingIntervalV2ResponseBody.from_dict(
                working_interval_item_data
            )

            working_interval.append(working_interval_item)

        schedule_rotation_v2_response_body = cls(
            handover_start_at=handover_start_at,
            handovers=handovers,
            id=id,
            layers=layers,
        ...
        schedule_rotation_v2_response_body.additional_properties = d
        return schedule_rotation_v2_response_body
