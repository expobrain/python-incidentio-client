...
class CatalogTypeV2ResponseBody:
    ...
    Example:
        {'annotations': {'incident.io/catalog-importer/id': 'id-of-config'}, 'color': 'slate', 'created_at':
            ...
            'schema': {'attributes': [{'array': False, 'external': False, 'id': '01GW2G3V0S59R238FAHPDS1R66', 'name':
            'tier', 'type': 'Custom["Service"]'}], 'version': 1}, 'semantic_type': 'custom', 'type_name':
    ...
    Attributes:
        ...
        schema (CatalogTypeSchemaV2ResponseBody):  Example: {'attributes': [{'array': False, 'external': False, 'id':
            '01GW2G3V0S59R238FAHPDS1R66', 'name': 'tier', 'type': 'Custom["Service"]'}], 'version': 1}.
