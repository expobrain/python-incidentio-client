...
T = TypeVar("T", bound="ScheduleEntriesV2ListResponseBody")


@_attrs_define
class ScheduleEntriesV2ListResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        schedule_entries_v2_list_response_body = cls(
            schedule_entries=schedule_entries,
            pagination_meta=pagination_meta,
        )

        schedule_entries_v2_list_response_body.additional_properties = d
        return schedule_entries_v2_list_response_body
