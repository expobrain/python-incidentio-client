...
from ..models.webhook_incident_v2_response_body_mode import (
    WebhookIncidentV2ResponseBodyMode,
)
from ..models.webhook_incident_v2_response_body_visibility import (
...
T = TypeVar("T", bound="WebhookIncidentV2ResponseBody")


@_attrs_define
class WebhookIncidentV2ResponseBody:
    """
    Example:
    ...
    Attributes:
        ...
        mode (WebhookIncidentV2ResponseBodyMode): Whether the incident is real, a test, a tutorial, or importing as a
        ...
        visibility (WebhookIncidentV2ResponseBodyVisibility): Whether the incident should be open to anyone in your
            Slack workspace (public), or invite-only (private). For more information on Private Incidents see our [help
    ...
    mode: WebhookIncidentV2ResponseBodyMode
    name: str
    reference: str
    slack_channel_id: str
    slack_team_id: str
    updated_at: datetime.datetime
    visibility: WebhookIncidentV2ResponseBodyVisibility
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        mode = WebhookIncidentV2ResponseBodyMode(d.pop("mode"))
        ...
        visibility = WebhookIncidentV2ResponseBodyVisibility(d.pop("visibility"))
        ...
        webhook_incident_v2_response_body = cls(
            created_at=created_at,
            creator=creator,
            custom_field_entries=custom_field_entries,
            id=id,
        ...
        webhook_incident_v2_response_body.additional_properties = d
        return webhook_incident_v2_response_body
