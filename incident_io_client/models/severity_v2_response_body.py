...
T = TypeVar("T", bound="SeverityV2ResponseBody")
...
class SeverityV2ResponseBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        severity_v2_response_body.additional_properties = d
        return severity_v2_response_body
