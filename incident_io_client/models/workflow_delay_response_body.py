...
T = TypeVar("T", bound="WorkflowDelayResponseBody")


@_attrs_define
class WorkflowDelayResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        workflow_delay_response_body = cls(
            conditions_apply_over_delay=conditions_apply_over_delay,
            for_seconds=for_seconds,
        )

        workflow_delay_response_body.additional_properties = d
        return workflow_delay_response_body
