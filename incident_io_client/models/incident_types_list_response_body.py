...
T = TypeVar("T", bound="IncidentTypesListResponseBody")


@attr.s(auto_attribs=True)
class IncidentTypesListResponseBody:
    """
    Example:
        {'incident_types': [{'created_at': '2021-08-17T13:28:57.801578Z', 'description': 'Customer facing production
            ...
            '01FCNDV6P870EA6S7TK1DSYDG0', 'is_default': False, 'name': 'Production Outage', 'private_incidents_only': True,
    ...
    Attributes:
        incident_types (List[IncidentTypeResponseBody]):  Example: [{'created_at': '2021-08-17T13:28:57.801578Z',
    ...
    incident_types: List[IncidentTypeResponseBody]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for incident_types_item_data in _incident_types:
            incident_types_item = IncidentTypeResponseBody.from_dict(incident_types_item_data)

            incident_types.append(incident_types_item)

        incident_types_list_response_body = cls(
            incident_types=incident_types,
        )

        incident_types_list_response_body.additional_properties = d
        return incident_types_list_response_body
