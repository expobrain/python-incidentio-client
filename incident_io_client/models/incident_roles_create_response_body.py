...
T = TypeVar("T", bound="IncidentRolesCreateResponseBody")


@attr.s(auto_attribs=True)
class IncidentRolesCreateResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        incident_roles_create_response_body = cls(
            incident_role=incident_role,
        )

        incident_roles_create_response_body.additional_properties = d
        return incident_roles_create_response_body
