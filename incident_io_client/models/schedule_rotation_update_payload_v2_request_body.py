...
if TYPE_CHECKING:
    from ..models.schedule_layer_update_payload_v2_request_body import (
    ...
    from ..models.schedule_rotation_working_interval_update_payload_v2_request_body import (
...
T = TypeVar("T", bound="ScheduleRotationUpdatePayloadV2RequestBody")


@_attrs_define
class ScheduleRotationUpdatePayloadV2RequestBody:
    """
    Example:
    ...
    Attributes:
        ...
        layers (Union[Unset, List['ScheduleLayerUpdatePayloadV2RequestBody']]):  Example: [{'id':
        ...
        working_interval (Union[Unset, List['ScheduleRotationWorkingIntervalUpdatePayloadV2RequestBody']]):  Example:
    ...
    layers: Union[Unset, List["ScheduleLayerUpdatePayloadV2RequestBody"]] = UNSET
    name: Union[Unset, str] = UNSET
    users: Union[Unset, List["UserReferencePayloadV2RequestBody"]] = UNSET
    working_interval: Union[
        Unset, List["ScheduleRotationWorkingIntervalUpdatePayloadV2RequestBody"]
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for layers_item_data in _layers or []:
            layers_item = ScheduleLayerUpdatePayloadV2RequestBody.from_dict(layers_item_data)
        ...
        for working_interval_item_data in _working_interval or []:
            working_interval_item = (
                ScheduleRotationWorkingIntervalUpdatePayloadV2RequestBody.from_dict(
        ...
        schedule_rotation_update_payload_v2_request_body = cls(
        ...
        schedule_rotation_update_payload_v2_request_body.additional_properties = d
        return schedule_rotation_update_payload_v2_request_body
