...
if TYPE_CHECKING:
    ...
    from ..models.weekday_interval_config_v2_response_body import (
        WeekdayIntervalConfigV2ResponseBody,
    )


T = TypeVar("T", bound="EscalationPathV2ResponseBody")


@_attrs_define
class EscalationPathV2ResponseBody:
    """
    Example:
    ...
    Attributes:
        ...
        path (List['EscalationPathNodeV2ResponseBody']): The nodes that form the levels and branches of this escalation
            path. Example: [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'if_else': {'conditions': [{'operation': {'label':
        ...
        working_hours (Union[Unset, List['WeekdayIntervalConfigV2ResponseBody']]): The working hours for this escalation
            path. Example: [{'id': 'abc123', 'name': 'abc123', 'timezone': 'abc123', 'weekday_intervals': [{'end_time':
            '17:00', 'start_time': '09:00', 'weekday': 'abc123'}]}].
    """

    id: str
    name: str
    path: List["EscalationPathNodeV2ResponseBody"]
    working_hours: Union[Unset, List["WeekdayIntervalConfigV2ResponseBody"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for path_item_data in _path:
            path_item = EscalationPathNodeV2ResponseBody.from_dict(path_item_data)
        ...
        for working_hours_item_data in _working_hours or []:
            working_hours_item = WeekdayIntervalConfigV2ResponseBody.from_dict(
                working_hours_item_data
            )

            working_hours.append(working_hours_item)

        escalation_path_v2_response_body = cls(
            id=id,
            name=name,
            path=path,
        ...
        escalation_path_v2_response_body.additional_properties = d
        return escalation_path_v2_response_body
