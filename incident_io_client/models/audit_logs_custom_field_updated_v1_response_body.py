...
class AuditLogsCustomFieldUpdatedV1ResponseBody:
    """
    Example:
        {'action': 'custom_field.updated', 'actor': {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata': {'api_key':
            {'api_key_roles': ['incident_creator']}, 'external_resource': {'external_id': 'q1234', 'resource_type':
            'pager_duty_incident'}, 'user': {'base_role_slug': 'admin', 'custom_role_slugs': ['engineering']}}, 'name':
            'John Doe', 'type': 'user'}, 'context': {'location': '1.2.3.4', 'user_agent': 'Chrome/91.0.4472.114'},
            'occurred_at': '2021-08-17T13:28:57.801578Z', 'targets': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Affected
            teams', 'type': 'custom_field'}], 'version': 1}

    Attributes:
        action (str): The type of log entry that this is Example: custom_field.updated.
        actor (AuditLogActorV2ResponseBody):  Example: {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'metadata': {'api_key':
            {'api_key_roles': ['incident_creator']}, 'external_resource': {'external_id': 'q1234', 'resource_type':
            'pager_duty_incident'}, 'user': {'base_role_slug': 'admin', 'custom_role_slugs': ['engineering']}}, 'name':
            'John Doe', 'type': 'user'}.
