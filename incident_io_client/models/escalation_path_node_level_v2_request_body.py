...
from ..models.escalation_path_node_level_v2_request_body_time_to_ack_interval_condition import (
...
T = TypeVar("T", bound="EscalationPathNodeLevelV2RequestBody")
...
class EscalationPathNodeLevelV2RequestBody:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        escalation_path_node_level_v2_request_body.additional_properties = d
        return escalation_path_node_level_v2_request_body
