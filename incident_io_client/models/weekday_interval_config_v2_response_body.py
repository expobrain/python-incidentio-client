...
if TYPE_CHECKING:
    from ..models.weekday_interval_v2_response_body import WeekdayIntervalV2ResponseBody


T = TypeVar("T", bound="WeekdayIntervalConfigV2ResponseBody")


@_attrs_define
class WeekdayIntervalConfigV2ResponseBody:
    """
    Example:
    ...
    Attributes:
        ...
        weekday_intervals (List['WeekdayIntervalV2ResponseBody']):  Example: [{'end_time': '17:00', 'start_time':
            '09:00', 'weekday': 'abc123'}].
    """

    id: str
    name: str
    timezone: str
    weekday_intervals: List["WeekdayIntervalV2ResponseBody"]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.weekday_interval_v2_response_body import (
        ...
        for weekday_intervals_item_data in _weekday_intervals:
            weekday_intervals_item = WeekdayIntervalV2ResponseBody.from_dict(
                weekday_intervals_item_data
            )

            weekday_intervals.append(weekday_intervals_item)

        weekday_interval_config_v2_response_body = cls(
            id=id,
            name=name,
            timezone=timezone,
            weekday_intervals=weekday_intervals,
        ...
        weekday_interval_config_v2_response_body.additional_properties = d
        return weekday_interval_config_v2_response_body
