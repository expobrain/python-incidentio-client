...
from ..models.create_workflow_payload_request_body_runs_on_incident_modes_item import (
    CreateWorkflowPayloadRequestBodyRunsOnIncidentModesItem,
)
from ..models.create_workflow_payload_request_body_runs_on_incidents import (
    CreateWorkflowPayloadRequestBodyRunsOnIncidents,
)
from ..models.create_workflow_payload_request_body_state import (
    CreateWorkflowPayloadRequestBodyState,
)
...
if TYPE_CHECKING:
    ...
    from ..models.create_workflow_payload_request_body_annotations import (
        CreateWorkflowPayloadRequestBodyAnnotations,
    )
...
T = TypeVar("T", bound="CreateWorkflowPayloadRequestBody")


@_attrs_define
class CreateWorkflowPayloadRequestBody:
    """
    Example:
        {'annotations': {'abc123': 'abc123'}, 'condition_groups': [{'conditions': [{'operation': 'one_of',
            ...
            'param_bindings': [{'array_value': [{'literal': 'SEV123', 'reference': 'incident.severity'}], 'value':
            {'literal': 'SEV123', 'reference': 'incident.severity'}}]}], 'trigger': 'incident.updated'}
    ...
    Attributes:
        ...
        runs_on_incident_modes (List[CreateWorkflowPayloadRequestBodyRunsOnIncidentModesItem]): Which modes of incident
            this should run on (defaults to just standard incidents) Example: ['standard', 'retrospective'].
        runs_on_incidents (CreateWorkflowPayloadRequestBodyRunsOnIncidents): Which incidents should the workflow be
        ...
        annotations (Union[Unset, CreateWorkflowPayloadRequestBodyAnnotations]): Annotations that track internal
            metadata about this workflow Example: {'abc123': 'abc123'}.
        ...
        state (Union[Unset, CreateWorkflowPayloadRequestBodyState]): The state of the workflow (e.g. is it draft, or
    ...
    name: str
    once_for: List[str]
    runs_on_incident_modes: List[CreateWorkflowPayloadRequestBodyRunsOnIncidentModesItem]
    runs_on_incidents: CreateWorkflowPayloadRequestBodyRunsOnIncidents
    steps: List["StepConfigPayloadRequestBody"]
    trigger: str
    annotations: Union[Unset, "CreateWorkflowPayloadRequestBodyAnnotations"] = UNSET
    delay: Union[Unset, "WorkflowDelayRequestBody"] = UNSET
    folder: Union[Unset, str] = UNSET
    managed_source_url: Union[Unset, str] = UNSET
    state: Union[Unset, CreateWorkflowPayloadRequestBodyState] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for runs_on_incident_modes_item_data in _runs_on_incident_modes:
            runs_on_incident_modes_item = CreateWorkflowPayloadRequestBodyRunsOnIncidentModesItem(
        ...
        annotations: Union[Unset, CreateWorkflowPayloadRequestBodyAnnotations]
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = CreateWorkflowPayloadRequestBodyAnnotations.from_dict(_annotations)
        ...
        state: Union[Unset, CreateWorkflowPayloadRequestBodyState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = CreateWorkflowPayloadRequestBodyState(_state)

        create_workflow_payload_request_body = cls(
            condition_groups=condition_groups,
            continue_on_step_error=continue_on_step_error,
            expressions=expressions,
            include_private_incidents=include_private_incidents,
        ...
        create_workflow_payload_request_body.additional_properties = d
        return create_workflow_payload_request_body
