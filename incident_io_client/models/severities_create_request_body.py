...
T = TypeVar("T", bound="SeveritiesCreateRequestBody")


@attr.s(auto_attribs=True)
class SeveritiesCreateRequestBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        severities_create_request_body = cls(
            description=description,
            name=name,
            rank=rank,
        )

        severities_create_request_body.additional_properties = d
        return severities_create_request_body
