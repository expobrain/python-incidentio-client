...
from ..models.workflow_response_body_runs_on_incident_modes_item import (
    WorkflowResponseBodyRunsOnIncidentModesItem,
)
from ..models.workflow_response_body_runs_on_incidents import (
    WorkflowResponseBodyRunsOnIncidents,
)
from ..models.workflow_response_body_state import WorkflowResponseBodyState
...
if TYPE_CHECKING:
    ...
    from ..models.step_config_response_body import StepConfigResponseBody
    ...
    from ..models.workflow_response_body_annotations import (
        WorkflowResponseBodyAnnotations,
    )


T = TypeVar("T", bound="WorkflowResponseBody")


@_attrs_define
class WorkflowResponseBody:
    """
    Example:
        {'annotations': {'abc123': 'abc123'}, 'condition_groups': [{'conditions': [{'operation': {'label': 'Lawrence
            Jones', 'value': '01FCQSP07Z74QMMYPDDGQB9FTG'}, 'param_bindings': [{'array_value': [{'catalog_entry':
    ...
    Attributes:
        ...
        expressions (List['ExpressionV2ResponseBody']): Expressions that make variables available in the scope Example:
            [{'else_branch': {'result': {'array_value': [{'catalog_entry': {'archived_at': '2021-08-17T14:28:57.801578Z',
            'catalog_entry_id': '01FCNDV6P870EA6S7TK1DSYDG0', 'catalog_entry_name': 'Primary escalation', 'catalog_type_id':
            '01FCNDV6P870EA6S7TK1DSYDG0'}, 'helptext': 'Collection of standalone automations like auto-closing incidents.',
            'image_url': 'https://avatars.slack-edge.com/2021-08-09/2372763167857_6f65d94928b0a0ac590b_192.jpg',
            'is_image_slack_icon': False, 'label': 'Lawrence Jones', 'literal': 'SEV123', 'reference': 'incident.severity',
            ...
            edge.com/2021-08-09/2372763167857_6f65d94928b0a0ac590b_192.jpg', 'is_image_slack_icon': False, 'label':
            'Lawrence Jones', 'literal': 'SEV123', 'reference': 'incident.severity', 'sort_key': '000020', 'unavailable':
            False, 'value': 'abc123'}}}, 'id': '01G0J1EXE7AXZ2C93K61WBPYEH', 'label': 'Team Slack channel', 'operations':
            [{'branches': {'branches': [{'condition_groups': [{'conditions': [{'operation': {'label': 'Lawrence Jones',
            'value': '01FCQSP07Z74QMMYPDDGQB9FTG'}, 'param_bindings': [{'array_value': [{'catalog_entry': {'archived_at':
            '2021-08-17T14:28:57.801578Z', 'catalog_entry_id': '01FCNDV6P870EA6S7TK1DSYDG0', 'catalog_entry_name': 'Primary
            escalation', 'catalog_type_id': '01FCNDV6P870EA6S7TK1DSYDG0'}, 'helptext': 'Collection of standalone automations
            like auto-closing incidents.', 'image_url': 'https://avatars.slack-
            edge.com/2021-08-09/2372763167857_6f65d94928b0a0ac590b_192.jpg', 'is_image_slack_icon': False, 'label':
            ...
            'IncidentStatus'}}, 'filter': {'condition_groups': [{'conditions': [{'operation': {'label': 'Lawrence Jones',
            'value': '01FCQSP07Z74QMMYPDDGQB9FTG'}, 'param_bindings': [{'array_value': [{'catalog_entry': {'archived_at':
            '2021-08-17T14:28:57.801578Z', 'catalog_entry_id': '01FCNDV6P870EA6S7TK1DSYDG0', 'catalog_entry_name': 'Primary
            escalation', 'catalog_type_id': '01FCNDV6P870EA6S7TK1DSYDG0'}, 'helptext': 'Collection of standalone automations
            like auto-closing incidents.', 'image_url': 'https://avatars.slack-
        ...
        runs_on_incident_modes (List[WorkflowResponseBodyRunsOnIncidentModesItem]): Which modes of incident this should
            run on (defaults to just standard incidents) Example: ['standard', 'retrospective'].
        runs_on_incidents (WorkflowResponseBodyRunsOnIncidents): Which incidents should the workflow be applied to?
            Example: newly_created.
        state (WorkflowResponseBodyState): The state of the workflow (e.g. is it draft, or disabled) Example: active.
        steps (List['StepConfigResponseBody']): Steps that are executed as part of the workflow Example: [{'for_each':
            'abc123', 'id': 'abc123', 'label': 'PagerDuty Escalate', 'name': 'pagerduty.escalate', 'param_bindings':
            [{'array_value': [{'catalog_entry': {'archived_at': '2021-08-17T14:28:57.801578Z', 'catalog_entry_id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'catalog_entry_name': 'Primary escalation', 'catalog_type_id':
            '01FCNDV6P870EA6S7TK1DSYDG0'}, 'helptext': 'Collection of standalone automations like auto-closing incidents.',
            'image_url': 'https://avatars.slack-edge.com/2021-08-09/2372763167857_6f65d94928b0a0ac590b_192.jpg',
        ...
        annotations (Union[Unset, WorkflowResponseBodyAnnotations]): Annotations that track internal metadata about this
            workflow Example: {'abc123': 'abc123'}.
        ...
        managed_source_url (Union[Unset, str]): The url of the external repository where this workflow is managed
            Example: https://github.com/my-company/incident-io-workflows.
    ...
    runs_on_incident_modes: List[WorkflowResponseBodyRunsOnIncidentModesItem]
    runs_on_incidents: WorkflowResponseBodyRunsOnIncidents
    state: WorkflowResponseBodyState
    steps: List["StepConfigResponseBody"]
    trigger: "TriggerSlimResponseBody"
    version: int
    annotations: Union[Unset, "WorkflowResponseBodyAnnotations"] = UNSET
    delay: Union[Unset, "WorkflowDelayResponseBody"] = UNSET
    folder: Union[Unset, str] = UNSET
    managed_source_url: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        managed_source_url = self.managed_source_url
        ...
        if managed_source_url is not UNSET:
            field_dict["managed_source_url"] = managed_source_url
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for runs_on_incident_modes_item_data in _runs_on_incident_modes:
            runs_on_incident_modes_item = WorkflowResponseBodyRunsOnIncidentModesItem(
                runs_on_incident_modes_item_data
            )

            runs_on_incident_modes.append(runs_on_incident_modes_item)

        runs_on_incidents = WorkflowResponseBodyRunsOnIncidents(d.pop("runs_on_incidents"))

        state = WorkflowResponseBodyState(d.pop("state"))

        steps = []
        _steps = d.pop("steps")
        for steps_item_data in _steps:
            steps_item = StepConfigResponseBody.from_dict(steps_item_data)
        ...
        annotations: Union[Unset, WorkflowResponseBodyAnnotations]
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = WorkflowResponseBodyAnnotations.from_dict(_annotations)
        ...
        managed_source_url = d.pop("managed_source_url", UNSET)
        ...
        workflow_response_body = cls(
            ...
            delay=delay,
            folder=folder,
            managed_source_url=managed_source_url,
            runs_from=runs_from,
        )

        workflow_response_body.additional_properties = d
        return workflow_response_body
