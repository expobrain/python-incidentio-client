...
if TYPE_CHECKING:
    from ..models.catalog_entry_engine_param_binding_value_v2_response_body import (
        CatalogEntryEngineParamBindingValueV2ResponseBody,
    )


T = TypeVar("T", bound="CatalogEntryEngineParamBindingV2ResponseBody")


@_attrs_define
class CatalogEntryEngineParamBindingV2ResponseBody:
    """
    Example:
    ...
    Attributes:
        array_value (Union[Unset, List['CatalogEntryEngineParamBindingValueV2ResponseBody']]): If array_value is set,
            this helps render the values Example: [{'catalog_entry': {'archived_at': '2021-08-17T14:28:57.801578Z',
        ...
        value (Union[Unset, CatalogEntryEngineParamBindingValueV2ResponseBody]):  Example: {'catalog_entry':
            ...
            'reference': 'incident.severity', 'sort_key': 'abc123', 'unavailable': False, 'value': 'abc123'}.
    """

    array_value: Union[Unset, List["CatalogEntryEngineParamBindingValueV2ResponseBody"]] = UNSET
    value: Union[Unset, "CatalogEntryEngineParamBindingValueV2ResponseBody"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for array_value_item_data in _array_value or []:
            array_value_item = CatalogEntryEngineParamBindingValueV2ResponseBody.from_dict(
        ...
        value: Union[Unset, CatalogEntryEngineParamBindingValueV2ResponseBody]
        if isinstance(_value, Unset):
            value = UNSET
        else:
            value = CatalogEntryEngineParamBindingValueV2ResponseBody.from_dict(_value)

        catalog_entry_engine_param_binding_v2_response_body = cls(
            array_value=array_value,
            value=value,
        )

        catalog_entry_engine_param_binding_v2_response_body.additional_properties = d
        return catalog_entry_engine_param_binding_v2_response_body
