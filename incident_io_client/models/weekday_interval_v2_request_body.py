...
T = TypeVar("T", bound="WeekdayIntervalV2RequestBody")


@_attrs_define
class WeekdayIntervalV2RequestBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        weekday_interval_v2_request_body = cls(
            end_time=end_time,
            start_time=start_time,
            weekday=weekday,
        )

        weekday_interval_v2_request_body.additional_properties = d
        return weekday_interval_v2_request_body
