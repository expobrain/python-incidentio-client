...
class ExpressionBranchPayloadV2RequestBody:
    ...
    Attributes:
        condition_groups (List['ConditionGroupPayloadV2RequestBody']): When theses conditions are met, this branch will
            be evaluated Example: [{'conditions': [{'operation': 'one_of', 'param_bindings': [{'array_value': [{'literal':
            'SEV123', 'reference': 'incident.severity'}], 'value': {'literal': 'SEV123', 'reference':
