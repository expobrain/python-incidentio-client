...
T = TypeVar("T", bound="SeveritiesCreateResponseBody")


@attr.s(auto_attribs=True)
class SeveritiesCreateResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        severities_create_response_body = cls(
            severity=severity,
        )

        severities_create_response_body.additional_properties = d
        return severities_create_response_body
