...
T = TypeVar("T", bound="ActionsListResponseBody")


@attr.s(auto_attribs=True)
class ActionsListResponseBody:
    """
    Example:
        {'actions': [{'completed_at': '2021-08-17T13:28:57.801578Z', 'created_at': '2021-08-17T13:28:57.801578Z',
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for actions_item_data in _actions:
            actions_item = ActionResponseBody.from_dict(actions_item_data)

            actions.append(actions_item)

        actions_list_response_body = cls(
            actions=actions,
        )

        actions_list_response_body.additional_properties = d
        return actions_list_response_body
