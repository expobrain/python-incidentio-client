...
T = TypeVar("T", bound="AuditLogsPostmortemSectionCreatedV2ResponseBody")


@_attrs_define
class AuditLogsPostmortemSectionCreatedV2ResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        audit_logs_postmortem_section_created_v2_response_body = cls(
            action=action,
            actor=actor,
            context=context,
            occurred_at=occurred_at,
        ...
        audit_logs_postmortem_section_created_v2_response_body.additional_properties = d
        return audit_logs_postmortem_section_created_v2_response_body
