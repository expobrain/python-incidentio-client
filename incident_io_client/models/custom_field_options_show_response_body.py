...
T = TypeVar("T", bound="CustomFieldOptionsShowResponseBody")


@attr.s(auto_attribs=True)
class CustomFieldOptionsShowResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_field_options_show_response_body = cls(
            custom_field_option=custom_field_option,
        )

        custom_field_options_show_response_body.additional_properties = d
        return custom_field_options_show_response_body
