...
class IncidentRoleAssignmentPayloadV2RequestBody:
    ...
    Attributes:
        assignee (UserReferencePayloadV2RequestBody):  Example: {'email': 'bob@example.com', 'id':
    ...
    assignee: UserReferencePayloadV2RequestBody
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        d = src_dict.copy()
        assignee = UserReferencePayloadV2RequestBody.from_dict(d.pop("assignee"))
