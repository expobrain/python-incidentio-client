...
T = TypeVar("T", bound="EscalationPathRoundRobinConfigV2RequestBody")


@_attrs_define
class EscalationPathRoundRobinConfigV2RequestBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        escalation_path_round_robin_config_v2_request_body = cls(
            enabled=enabled,
            rotate_after_seconds=rotate_after_seconds,
        )

        escalation_path_round_robin_config_v2_request_body.additional_properties = d
        return escalation_path_round_robin_config_v2_request_body
