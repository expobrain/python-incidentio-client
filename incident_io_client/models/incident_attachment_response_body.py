...
from ..models.external_resource_response_body import ExternalResourceResponseBody

T = TypeVar("T", bound="IncidentAttachmentResponseBody")


@attr.s(auto_attribs=True)
class IncidentAttachmentResponseBody:
    """
    Example:
    ...
    Attributes:
        ...
        resource (ExternalResourceResponseBody):  Example: {'external_id': '123', 'permalink':
    ...
    id: str
    incident_id: str
    resource: ExternalResourceResponseBody
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resource = ExternalResourceResponseBody.from_dict(d.pop("resource"))

        incident_attachment_response_body = cls(
            id=id,
            incident_id=incident_id,
            resource=resource,
        )

        incident_attachment_response_body.additional_properties = d
        return incident_attachment_response_body
