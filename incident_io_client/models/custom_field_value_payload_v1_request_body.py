...
T = TypeVar("T", bound="CustomFieldValuePayloadV1RequestBody")
...
class CustomFieldValuePayloadV1RequestBody:
    ...
    Example:
        {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'value_link': 'https://google.com/', 'value_numeric': '123.456',
            ...
            'value_timestamp': 'Alias reiciendis quis.'}
    ...
    Attributes:
        ...
        value_timestamp (Union[Unset, str]):  Example: Repellat a delectus et deserunt voluptatem unde..
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom_field_value_payload_v1_request_body.additional_properties = d
        return custom_field_value_payload_v1_request_body
