...
if TYPE_CHECKING:
    from ..models.escalation_path_v2_response_body import EscalationPathV2ResponseBody
...
class EscalationsV2CreatePathResponseBody:
    ...
    Attributes:
        escalation_path (EscalationPathV2ResponseBody):  Example: {'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Urgent
            Support', 'path': [{'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'if_else': {'conditions': [{'operation': {'label':
    ...
    escalation_path: "EscalationPathV2ResponseBody"
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.escalation_path_v2_response_body import (
            EscalationPathV2ResponseBody,
        )

        d = src_dict.copy()
        escalation_path = EscalationPathV2ResponseBody.from_dict(d.pop("escalation_path"))
