...
T = TypeVar("T", bound="CustomFieldOptionsListResponseBody")


@attr.s(auto_attribs=True)
class CustomFieldOptionsListResponseBody:
    """
    Example:
    ...
    Attributes:
        custom_field_options (List[CustomFieldOptionResponseBody]):  Example: [{'custom_field_id':
            '01FCNDV6P870EA6S7TK1DSYDG0', 'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'sort_key': 10, 'value': 'Product'},
            {'custom_field_id': '01FCNDV6P870EA6S7TK1DSYDG0', 'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'sort_key': 10, 'value':
    ...
    custom_field_options: List[CustomFieldOptionResponseBody]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for custom_field_options_item_data in _custom_field_options:
            custom_field_options_item = CustomFieldOptionResponseBody.from_dict(
                custom_field_options_item_data
            )

            custom_field_options.append(custom_field_options_item)

        custom_field_options_list_response_body = cls(
            custom_field_options=custom_field_options,
        )

        custom_field_options_list_response_body.additional_properties = d
        return custom_field_options_list_response_body
