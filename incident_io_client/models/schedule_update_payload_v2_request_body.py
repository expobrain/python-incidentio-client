...
T = TypeVar("T", bound="ScheduleUpdatePayloadV2RequestBody")


@_attrs_define
class ScheduleUpdatePayloadV2RequestBody:
    """
    Example:
    ...
    Attributes:
        ...
        config (Union[Unset, ScheduleConfigUpdatePayloadV2RequestBody]):  Example: {'rotations': [{'effective_from':
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        annotations: Union[Unset, ScheduleUpdatePayloadV2RequestBodyAnnotations]
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = ScheduleUpdatePayloadV2RequestBodyAnnotations.from_dict(_annotations)

        _config = d.pop("config", UNSET)
        config: Union[Unset, ScheduleConfigUpdatePayloadV2RequestBody]
        ...
        schedule_update_payload_v2_request_body.additional_properties = d
        return schedule_update_payload_v2_request_body
