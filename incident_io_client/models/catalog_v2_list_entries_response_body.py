...
class CatalogV2ListEntriesResponseBody:
    ...
    Example:
        {'catalog_entries': [{'alias': 'incident-io/core', 'attribute_values': {'abc123': {'array_value':
            ...
            'rank': 3, 'updated_at': '2021-08-17T13:28:57.801578Z'}], 'catalog_type': {'color': 'slate', 'created_at':
            '2021-08-17T13:28:57.801578Z', 'description': 'Represents Kubernetes clusters that we run inside of GKE.',
            'estimated_count': 7, 'icon': 'box', 'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name': 'Kubernetes Cluster', 'ranked':
