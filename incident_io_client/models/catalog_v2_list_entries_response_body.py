...
class CatalogV2ListEntriesResponseBody:
    ...
    Example:
        {'catalog_entries': [{'aliases': ['lawrence@incident.io', 'lawrence'], 'attribute_values': {'abc123':
            ...
            'description': 'Represents Kubernetes clusters that we run inside of GKE.', 'estimated_count': 7,
            'external_type': 'PagerDutyService', 'icon': 'bolt', 'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'is_editable': False,
            'name': 'Kubernetes Cluster', 'ranked': True, 'required_integrations': ['pager_duty'], 'schema': {'attributes':
            [{'array': False, 'id': '01GW2G3V0S59R238FAHPDS1R66', 'name': 'tier', 'type':
            'CatalogEntry["01GVGYJSD39FRKVDWACK9NDS4E"]'}], 'version': 1}, 'semantic_type': 'custom', 'type_name':
            'CatalogEntry["01FCNDV6P870EA6S7TK1DSYDG2"]', 'updated_at': '2021-08-17T13:28:57.801578Z'}, 'pagination_meta':
    ...
    Attributes:
        ...
        catalog_type (CatalogTypeV2ResponseBody):  Example: {'color': 'slate', 'created_at':
            ...
            'CatalogEntry["01GVGYJSD39FRKVDWACK9NDS4E"]'}], 'version': 1}, 'semantic_type': 'custom', 'type_name':
            'CatalogEntry["01FCNDV6P870EA6S7TK1DSYDG2"]', 'updated_at': '2021-08-17T13:28:57.801578Z'}.
