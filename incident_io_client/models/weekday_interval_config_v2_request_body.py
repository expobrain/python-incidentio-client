...
if TYPE_CHECKING:
    from ..models.weekday_interval_v2_request_body import WeekdayIntervalV2RequestBody


T = TypeVar("T", bound="WeekdayIntervalConfigV2RequestBody")


@_attrs_define
class WeekdayIntervalConfigV2RequestBody:
    """
    Example:
    ...
    Attributes:
        ...
        weekday_intervals (List['WeekdayIntervalV2RequestBody']):  Example: [{'end_time': '17:00', 'start_time':
    ...
    name: str
    timezone: str
    weekday_intervals: List["WeekdayIntervalV2RequestBody"]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.weekday_interval_v2_request_body import (
        ...
        for weekday_intervals_item_data in _weekday_intervals:
            weekday_intervals_item = WeekdayIntervalV2RequestBody.from_dict(
                weekday_intervals_item_data
            )

            weekday_intervals.append(weekday_intervals_item)

        weekday_interval_config_v2_request_body = cls(
            id=id,
            name=name,
            timezone=timezone,
            weekday_intervals=weekday_intervals,
        ...
        weekday_interval_config_v2_request_body.additional_properties = d
        return weekday_interval_config_v2_request_body
