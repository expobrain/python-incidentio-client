...
T = TypeVar("T", bound="EngineReferenceV2ResponseBody")


@_attrs_define
class EngineReferenceV2ResponseBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        engine_reference_v2_response_body = cls(
            array=array,
            key=key,
            label=label,
            type=type,
        ...
        engine_reference_v2_response_body.additional_properties = d
        return engine_reference_v2_response_body
