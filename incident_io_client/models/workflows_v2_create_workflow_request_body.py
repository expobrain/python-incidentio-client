...
if TYPE_CHECKING:
    from ..models.create_workflow_payload_request_body import (
...
class WorkflowsV2CreateWorkflowRequestBody:
    ...
    Attributes:
        workflow (CreateWorkflowPayloadRequestBody):  Example: {'annotations': {'abc123': 'abc123'}, 'condition_groups':
    ...
    workflow: "CreateWorkflowPayloadRequestBody"
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        workflow = CreateWorkflowPayloadRequestBody.from_dict(d.pop("workflow"))
