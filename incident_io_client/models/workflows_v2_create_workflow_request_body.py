...
from ..models.workflows_v2_create_workflow_request_body_runs_on_incident_modes_item import (
    WorkflowsV2CreateWorkflowRequestBodyRunsOnIncidentModesItem,
)
from ..models.workflows_v2_create_workflow_request_body_runs_on_incidents import (
    WorkflowsV2CreateWorkflowRequestBodyRunsOnIncidents,
)
from ..models.workflows_v2_create_workflow_request_body_state import (
...
if TYPE_CHECKING:
    ...
    from ..models.workflows_v2_create_workflow_request_body_annotations import (
        WorkflowsV2CreateWorkflowRequestBodyAnnotations,
    )


T = TypeVar("T", bound="WorkflowsV2CreateWorkflowRequestBody")


@_attrs_define
class WorkflowsV2CreateWorkflowRequestBody:
    """
    Example:
        {'annotations': {'incident.io/terraform/version': '3.0.0'}, 'condition_groups': [{'conditions': [{'operation':
            ...
            'incident.severity'}], 'value': {'literal': 'SEV123', 'reference': 'incident.severity'}}]}], 'trigger':
            'incident.updated'}
    ...
    Attributes:
        ...
        runs_on_incident_modes (List[WorkflowsV2CreateWorkflowRequestBodyRunsOnIncidentModesItem]): Which modes of
            incident this should run on (defaults to just standard incidents) Example: ['standard', 'retrospective'].
        runs_on_incidents (WorkflowsV2CreateWorkflowRequestBodyRunsOnIncidents): Which incidents should the workflow be
        ...
        annotations (Union[Unset, WorkflowsV2CreateWorkflowRequestBodyAnnotations]): Annotations that track metadata
        ...
        state (Union[Unset, WorkflowsV2CreateWorkflowRequestBodyState]): The state of the workflow (e.g. is it draft, or
    ...
    name: str
    once_for: List[str]
    runs_on_incident_modes: List[WorkflowsV2CreateWorkflowRequestBodyRunsOnIncidentModesItem]
    runs_on_incidents: WorkflowsV2CreateWorkflowRequestBodyRunsOnIncidents
    steps: List["StepConfigPayloadRequestBody"]
    trigger: str
    annotations: Union[Unset, "WorkflowsV2CreateWorkflowRequestBodyAnnotations"] = UNSET
    delay: Union[Unset, "WorkflowDelayRequestBody"] = UNSET
    folder: Union[Unset, str] = UNSET
    state: Union[Unset, WorkflowsV2CreateWorkflowRequestBodyState] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        annotations: Union[Unset, WorkflowsV2CreateWorkflowRequestBodyAnnotations]
        if isinstance(_annotations, Unset):
            annotations = UNSET
        else:
            annotations = WorkflowsV2CreateWorkflowRequestBodyAnnotations.from_dict(_annotations)
        ...
        state: Union[Unset, WorkflowsV2CreateWorkflowRequestBodyState]
        if isinstance(_state, Unset):
            state = UNSET
        else:
            state = WorkflowsV2CreateWorkflowRequestBodyState(_state)

        workflows_v2_create_workflow_request_body = cls(
            condition_groups=condition_groups,
            continue_on_step_error=continue_on_step_error,
            expressions=expressions,
            include_private_incidents=include_private_incidents,
        ...
        workflows_v2_create_workflow_request_body.additional_properties = d
        return workflows_v2_create_workflow_request_body
