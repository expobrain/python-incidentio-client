...
if TYPE_CHECKING:
    from ..models.catalog_entry_reference import CatalogEntryReference


T = TypeVar("T", bound="EngineParamBindingValue")


@_attrs_define
class EngineParamBindingValue:
    """
    Example:
    ...
    Attributes:
        ...
        catalog_entry (Union[Unset, CatalogEntryReference]):  Example: {'archived_at': '2021-08-17T14:28:57.801578Z',
    ...
    label: str
    sort_key: str
    catalog_entry: Union[Unset, "CatalogEntryReference"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        catalog_entry: Union[Unset, CatalogEntryReference]
        if isinstance(_catalog_entry, Unset):
            catalog_entry = UNSET
        else:
            catalog_entry = CatalogEntryReference.from_dict(_catalog_entry)
        ...
        engine_param_binding_value = cls(
            label=label,
            sort_key=sort_key,
        ...
        engine_param_binding_value.additional_properties = d
        return engine_param_binding_value
