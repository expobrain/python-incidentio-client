...
T = TypeVar("T", bound="ScheduleEntriesListPayloadV2ResponseBody")


@_attrs_define
class ScheduleEntriesListPayloadV2ResponseBody:
    """
    Example:
    ...
    Attributes:
        final (List['ScheduleEntryV2ResponseBody']):  Example: [{'end_at': '2021-08-17T13:28:57.801578Z', 'entry_id':
            '01G0J1EXE7AXZ2C93K61WBPYEH', 'fingerprint': '01G0J1EXE7AXZ2C93K61WBPYEH', 'layer_id':
            '01G0J1EXE7AXZ2C93K61WBPYNH', 'rotation_id': '01G0J1EXE7AXZ2C93K61WBPYEH', 'start_at':
            '2021-08-17T13:28:57.801578Z', 'user': {'email': 'lisa@incident.io', 'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name':
            'Lisa Karlin Curtis', 'role': 'viewer', 'slack_user_id': 'U02AYNF2XJM'}}].
        overrides (List['ScheduleEntryV2ResponseBody']):  Example: [{'end_at': '2021-08-17T13:28:57.801578Z',
            'entry_id': '01G0J1EXE7AXZ2C93K61WBPYEH', 'fingerprint': '01G0J1EXE7AXZ2C93K61WBPYEH', 'layer_id':
            '01G0J1EXE7AXZ2C93K61WBPYNH', 'rotation_id': '01G0J1EXE7AXZ2C93K61WBPYEH', 'start_at':
            '2021-08-17T13:28:57.801578Z', 'user': {'email': 'lisa@incident.io', 'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name':
            'Lisa Karlin Curtis', 'role': 'viewer', 'slack_user_id': 'U02AYNF2XJM'}}].
        scheduled (List['ScheduleEntryV2ResponseBody']):  Example: [{'end_at': '2021-08-17T13:28:57.801578Z',
            'entry_id': '01G0J1EXE7AXZ2C93K61WBPYEH', 'fingerprint': '01G0J1EXE7AXZ2C93K61WBPYEH', 'layer_id':
            '01G0J1EXE7AXZ2C93K61WBPYNH', 'rotation_id': '01G0J1EXE7AXZ2C93K61WBPYEH', 'start_at':
            '2021-08-17T13:28:57.801578Z', 'user': {'email': 'lisa@incident.io', 'id': '01FCNDV6P870EA6S7TK1DSYDG0', 'name':
            'Lisa Karlin Curtis', 'role': 'viewer', 'slack_user_id': 'U02AYNF2XJM'}}].
    ...
    final: List["ScheduleEntryV2ResponseBody"]
    overrides: List["ScheduleEntryV2ResponseBody"]
    scheduled: List["ScheduleEntryV2ResponseBody"]
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for overrides_item_data in _overrides:
            overrides_item = ScheduleEntryV2ResponseBody.from_dict(overrides_item_data)
        ...
        for scheduled_item_data in _scheduled:
            scheduled_item = ScheduleEntryV2ResponseBody.from_dict(scheduled_item_data)

            scheduled.append(scheduled_item)

        schedule_entries_list_payload_v2_response_body = cls(
            final=final,
            overrides=overrides,
            scheduled=scheduled,
        )

        schedule_entries_list_payload_v2_response_body.additional_properties = d
        return schedule_entries_list_payload_v2_response_body
