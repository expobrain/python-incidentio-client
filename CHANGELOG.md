...
- **deps-dev**: bump ruamel-yaml from 0.18.10 to 0.18.12
...
- Updated API at 2025-04-21

## 0.55.6 (2025-04-26)

### Fix

- **deps**: bump h11 from 0.14.0 to 0.16.0 in the pip group

## 0.55.5 (2025-04-26)

### Fix

- **deps-dev**: bump mkdocs-material from 9.6.11 to 9.6.12
...
- **deps-dev**: bump mkdocs-material from 9.6.10 to 9.6.11

## 0.55.2 (2025-04-03)

### Fix

- **deps**: bump attrs from 25.1.0 to 25.3.0

## 0.55.1 (2025-04-03)

### Fix

- **deps-dev**: bump mkdocs-material from 9.6.7 to 9.6.10

## 0.55.0 (2025-03-12)

### Feat

- Updated API at 2025-02-24
...
- **deps-dev**: bump types-setuptools
- **deps-dev**: bump mkdocs-material from 9.5.44 to 9.5.45

## 0.53.8 (2024-11-25)

### Fix

- **deps-dev**: bump openapi-python-client from 0.21.6 to 0.21.7
...
- **deps-dev**: bump commitizen from 3.30.0 to 3.30.1

## 0.53.4 (2024-11-06)

### Fix

- **deps-dev**: bump flake8-bugbear from 24.8.19 to 24.10.31
...
- **deps-dev**: bump mypy from 1.11.2 to 1.12.1 in /example

## 0.53.0 (2024-10-14)

### Feat

- Updated API at 2024-10-14
...
- **deps-dev**: bump openapi-python-client from 0.21.4 to 0.21.5
...
- **deps**: bump httpx from 0.27.0 to 0.27.2

## 0.52.0 (2024-08-27)

### Feat

- Updated API at 2024-08-27

## 0.51.1 (2024-08-27)

### Fix

- **deps-dev**: bump openapi-python-client from 0.21.3 to 0.21.4
...
- **deps-dev**: bump mypy from 1.11.1 to 1.11.2 in /example
- **deps-dev**: bump mypy from 1.11.1 to 1.11.2

## 0.50.0 (2024-08-25)

### Feat

- Updated API at 2024-08-19
...
- **deps-dev**: bump flake8-bugbear from 23.3.12 to 24.8.19

## 0.49.15 (2024-08-23)

### Fix

- **deps-dev**: bump mkdocs-material from 9.5.31 to 9.5.33

## 0.49.14 (2024-08-23)

### Fix

- **deps-dev**: bump commitizen from 3.28.0 to 3.29.0

## 0.49.13 (2024-08-23)

### Fix

- **deps-dev**: bump flake8 from 5.0.4 to 7.1.1
...
- **deps-dev**: bump mkdocstrings-python from 1.10.5 to 1.10.8

## 0.49.10 (2024-08-23)

### Fix

- **deps-dev**: bump pyupgrade from 3.8.0 to 3.16.0

## 0.49.9 (2024-08-23)

### Fix

- **deps-dev**: bump openapi-python-client from 0.21.2 to 0.21.3
...
- **deps-dev**: bump mypy from 1.11.0 to 1.11.1 in /example
...
- **deps**: bump attrs from 23.2.0 to 24.2.0
...
- **deps-dev**: bump mkdocs-material from 9.5.27 to 9.5.29
...
- **deps-dev**: bump mypy from 1.10.0 to 1.10.1
...
- Updated API at 2024-06-17 (#478)

## 0.45.7 (2024-06-18)

### Fix

- **deps-dev**: bump types-setuptools (#473)
- **deps-dev**: bump mypy from 1.9.0 to 1.10.0 in /example (#458)

## 0.45.6 (2024-06-18)

### Fix

- **deps-dev**: bump mkdocstrings-python from 1.9.2 to 1.10.4 (#481)
...
- **deps-dev**: bump mypy from 1.9.0 to 1.10.0 (#461)
...
- **deps-dev**: bump black from 24.3.0 to 24.4.2 (#454)

## 0.45.1 (2024-04-30)

### Fix

- **deps-dev**: bump commitizen from 3.21.3 to 3.24.0 (#451)
...
- **deps**: bump idna from 3.3 to 3.7 in /example (#442)
...
- **deps-dev**: bump mkdocs-material from 9.5.15 to 9.5.16 (#437)
...
- **deps-dev**: bump mkdocs-material from 9.5.13 to 9.5.15 (#427)
...
- **deps-dev**: bump mkdocs-material from 9.5.12 to 9.5.13 (#417)

## 0.41.0 (2024-03-08)

### Feat

- Updated API at 2024-03-08 (#409)
...
- **deps-dev**: bump types-setuptools (#392)
...
- **deps-dev**: bump mypy from 1.7.1 to 1.8.0 in /example (#357)
...
- **deps-dev**: bump commitizen from 3.13.0 to 3.14.1 (#385)
...
- Updated API at 2024-01-22 (#368)

## 0.37.9 (2024-01-22)

### Fix

- **deps-dev**: bump types-pygments from 2.17.0.0 to 2.17.0.20240106 (#375)
...
- **deps-dev**: bump types-python-dateutil (#374)

## 0.37.6 (2024-01-21)

### Fix

- **deps-dev**: bump isort from 5.13.0 to 5.13.2 (#353)

## 0.37.5 (2024-01-21)

### Fix

- **deps-dev**: bump black from 23.11.0 to 23.12.1 (#359)

## 0.37.4 (2024-01-21)

### Fix

- **deps**: bump httpx from 0.25.2 to 0.26.0 (#361)
...
- **deps-dev**: bump mkdocs-material from 9.5.1 to 9.5.4 (#367)

## 0.37.1 (2024-01-21)

### Fix

- **deps-dev**: bump jinja2 from 3.0.3 to 3.1.3 (#364)

## 0.37.0 (2024-01-21)

### Feat

- Updated API at 2023-12-11 (#344)
...
- **deps-dev**: bump mkdocs-material from 9.4.14 to 9.5.1 (#350)
